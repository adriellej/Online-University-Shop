...
@Component({
  selector: 'app-pv-college-barong',
  templateUrl: './pv-college-barong.page.html',
  styleUrls: ['./pv-college-barong.page.scss'],
})
export class PVCollegeBarongPage implements OnInit {
  quantity: number = 1;
  isClicked = false;
