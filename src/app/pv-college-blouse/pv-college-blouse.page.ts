...
@Component({
  selector: 'app-pv-college-blouse',
  templateUrl: './pv-college-blouse.page.html',
  styleUrls: ['./pv-college-blouse.page.scss'],
})
export class PvCollegeBlousePage implements OnInit {
