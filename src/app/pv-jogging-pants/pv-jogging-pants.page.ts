...
@Component({
  selector: 'app-pv-jogging-pants',
  templateUrl: './pv-jogging-pants.page.html',
  styleUrls: ['./pv-jogging-pants.page.scss'],
})
export class PvJoggingPantsPage implements OnInit {
