...
@Component({
  selector: 'app-pv-college-skirt',
  templateUrl: './pv-college-skirt.page.html',
  styleUrls: ['./pv-college-skirt.page.scss'],
})
export class PvCollegeSkirtPage implements OnInit {
