...
@Component({
  selector: 'app-pv-college-shirt',
  templateUrl: './pv-college-shirt.page.html',
  styleUrls: ['./pv-college-shirt.page.scss'],
})
export class PvCollegeShirtPage implements OnInit {
  quantity: number = 1;
  isClicked = false;
